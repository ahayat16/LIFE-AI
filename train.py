...
def get_parser():
    ...
    parser.add_argument("--n_hidden_layers", type=int, default=1,
                        help="Number of FFN layers in Transformer")
    ...
    parser.add_argument("--env_name", type=str, default="graph",
                        help="Environment name")
    ENVS[parser.parse_known_args()[0].env_name].register_args(parser)

    # tasks
    parser.add_argument("--tasks", type=str, default="graph",
                        help="Tasks")
...
if __name__ == '__main__':
    ...
    if params.eval_only and params.eval_from_exp != "":
        ...
        del pickled_args['batch_size']
        del pickled_args['batch_size_eval']
        del pickled_args['fp16']
        del pickled_args['amp']
        del pickled_args['max_len']
        del pickled_args['dump_path']
        del pickled_args['eval_from_exp']
        del pickled_args['eval_data']
        del pickled_args['eval_verbose']
        del pickled_args['float_tolerance']
